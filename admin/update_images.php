<?php
  ...
  if(!isset($_SESSION['admin_logged_in'])) {
    ...
    if(isset($_POST['update_images'])){ //makes sure user clicked on the update images button 
        ...
        move_uploaded_file($image1,"../assets/imgs/".$image_name1); //move_uploaded_file(file, dest)
