...
<?php
  ...
  //2.return no.of products
    ...
    $stmt1 = $conn->prepare("SELECT COUNT(*) As total_records FROM users"); //returns total no.of products in database
  ...
  //4. Get all products
    ...
    $stmt2 = $conn->prepare("SELECT * FROM payments LIMIT $offset,$total_records_per_page");
