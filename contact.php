...
if(isset($_POST)){
    ...
    $stmt1 = $conn->prepare("INSERT INTO contact_us (name, email, message) VALUES (?,?,?)");
    ...
    <section id="contact" class="container my-5 py-5">
        <div class="container text-center mt-5">
            ...
            <p class="w-50  mx-auto">
                Phone: <span>+91 7907569250</span>
            </p>
            <p class="w-50  mx-auto">
                Email: <span>contact@weaved.com</span>
            </p>
            <p class="w-50  mx-auto">
...
<div class="contact-container">
  ...
  <div class="description">Dark Mode</div>
    ...
    <p>Have any questions regarding your purchase? Hit us up. We'd love to help.</p>
